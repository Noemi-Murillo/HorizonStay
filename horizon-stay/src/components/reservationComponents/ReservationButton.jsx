...
const ReservationButton = ({ disabled = false }) => {
  return (
    <StyledWrapper>
      <button type='submit' disabled={disabled} className={disabled ? 'disabled' : ''} >
        Enviar reserva
...
button {
  ...
  border: none;
  border-radius: 8px;
  box-shadow: 2px 2px 5px #18181869; /* ← sombra exterior únicamente */
